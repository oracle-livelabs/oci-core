...
7. If the user did not receive the email, in the user details, you have a reset password button that will send a password reset link.
...
12. Verify user permissions when a user belongs to a specific group.

      * Sign in with the local **Test User** account you created. Remember to use the latest password you assigned to this user.

      * Click the **Navigation Menu**. Click **Compute** and then click **Instances**.
